...
DB_NAME = os.environ.get("DB_NAME", "Royal")
DB_URL = os.environ.get("DB_URL", "mongodb+srv://Royaldwip:Royaldwip@cluster0.jldedgb.mongodb.net/?retryWrites=true&w=majority")
