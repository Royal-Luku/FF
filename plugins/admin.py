...
async def buypremium(bot, message):
	await message.reply_text(" Select Plan to upgrade...", quote=True, 
				 reply_markup = InlineKeyboardMarkup([[InlineKeyboardButton("💠 Plan 1 💠", callback_data="vip1"),
...
async def vip1(bot,update):
	...
	addpre(int(user_id))
	await update.message.edit("Added successfully To Premium Upload limit 15 GB")
	await bot.send_message(user_id,"__Hey You are Upgraded To 💠 **Plan 1** 💠.\n\nCheck Your Plan via /myplan__")
...
async def vip2(bot,update):
	...
	addpre(int(user_id))
	await update.message.edit("Added successfully To Premium Upload limit 30 GB")
...
async def vip4(bot,update):
	...
	await bot.send_message(user_id,"__Hey You are Upgraded To 💠 **Plan 4** 💠.\nCheck Your Plan via /myplan__")
